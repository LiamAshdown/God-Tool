...
public:
    ...
    virtual V3Position& GetPosition(V3Position &pos); // 11 GetPosition(C3Vector &)
    virtual V3Position& GetRawPosition(V3Position &pos); // 12 GetRawPosition(C3Vector &)
