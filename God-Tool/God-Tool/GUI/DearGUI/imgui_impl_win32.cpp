...
IMGUI_IMPL_API LRESULT ImGui_ImplWin32_WndProcHandler(HWND hwnd, UINT m_Msg, WPARAM wParam, LPARAM lParam)
{
    ...
    {
        int button = 0;
        if (m_Msg == WM_LBUTTONDOWN || m_Msg == WM_LBUTTONDBLCLK) button = 0;
        if (m_Msg == WM_RBUTTONDOWN || m_Msg == WM_RBUTTONDBLCLK) button = 1;
        if (m_Msg == WM_MBUTTONDOWN || m_Msg == WM_MBUTTONDBLCLK) button = 2;
    ...
    {
        int button = 0;
        if (m_Msg == WM_LBUTTONUP) button = 0;
        if (m_Msg == WM_RBUTTONUP) button = 1;
        if (m_Msg == WM_MBUTTONUP) button = 2;
